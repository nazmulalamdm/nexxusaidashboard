...
export default function OverviewPage() {
  ...
  return (
    <div className="p-4 lg:p-6 space-y-4 max-w-[1600px] mx-auto">
      ...
      <div className="rounded-xl bg-gradient-to-r from-[#7367f0]/20 via-[#272b40] to-[#272b40] border border-slate-700/80 p-4 lg:p-5 shadow-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 font-mono text-xs">
            <div className="px-3 py-1.5 rounded-md bg-[#1f2233] border border-slate-700/80 text-slate-200 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        <div className="p-4 rounded-xl bg-[#272b40] border border-slate-700/80 shadow-xs">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        {/* Main Chart with Visible Grid */}
        <div className="lg:col-span-2 bg-[#272b40] p-4 rounded-xl border border-slate-700/80 shadow-xs">
                ...
                >
                  <defs>
                    <linearGradient id="velocityGrad" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="#7367f0" stopOpacity={0.45} />
                      <stop offset="95%" stopColor="#7367f0" stopOpacity={0.0} />
                    </linearGradient>
                  </defs>
                  {/* গ্রিড লাইন স্পষ্টভাবে দৃশ্যমান করার জন্য কালার শার্প করা হয়েছে */}
                  <CartesianGrid
                    strokeDasharray="4 4"
                    vertical={false}
                    stroke="#434968"
                  ...
                  <Tooltip
                    content={({ active, payload, label }) => {
                      if (active && payload && payload.length) {
                        return (
                          <div className="bg-[#1f2233] p-2.5 rounded-md shadow-lg border border-slate-700 text-xs font-mono">
                            <p className="text-slate-400 mb-0.5">{label} UTC</p>
        ...
        <div className="bg-[#272b40] p-4 rounded-xl border border-slate-700/80 shadow-xs flex flex-col justify-between">
          <div>
          ...
          <div className="pt-3 border-t border-slate-700/80 flex items-center justify-between text-xs">
            <span className="text-slate-400">Dominant: Claude 3.5</span>
            <a
              href="/clients"
      ...
      <div className="bg-[#272b40] rounded-xl border border-slate-700/80 overflow-hidden shadow-xs">
        <div className="p-3 border-b border-slate-700/80 flex items-center justify-between">
          <div className="flex items-center gap-2">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="text-[11px] font-semibold uppercase tracking-wider bg-slate-900/60 text-slate-400 border-b border-slate-700/80">
            ...
            <tbody className="divide-y divide-slate-700/60 text-xs text-slate-300">
              {livePipelines.map((pod) => (
                ...
                >
                  ...
                  <td className="py-2.5 px-4 text-right font-mono text-[11px] text-slate-200">
                    {pod.throughput}
                  </td>
                  <td className="py-2.5 px-4 text-right font-mono text-[11px] text-emerald-400">
                    {pod.latency}
                  </td>
